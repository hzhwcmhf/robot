...
std::vector<MotorController::BodyVeclocity> MotorController::turnToPath(RobotCoordinator & robot, Path & path)
{
...
std::vector<MotorController::BodyVeclocity> MotorController::trackPath(RobotCoordinator &robot, Path &path, bool debug)
{
